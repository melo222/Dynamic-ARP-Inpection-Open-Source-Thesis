...
% ----------------- Dimensione Coda Maggiore --------------------
            ...
            In questo contesto estremo, si osserva un fisiologico aumento della latenza media (\textbf{$\sim$270 $\mu$s}), imputabile alla contesa dei \textit{lock} tra i due thread ricevitori e i quattro analizzatori che accedono contemporaneamente alla coda condivisa.
