\chapter{Soluzioni ad ARP Poisoning}
    ...
    In primo luogo, presentiamo le soluzioni implementate sui singoli nodi della rete per validare l'intera infrastruttura: un paradigma interessante, ma con alcuni punti critici.
        ...
        Questa soluzione non è esente da difetti, in quanto presenta le stesse difficoltà di implementazione della precedente in reti eterogenee e con un alto ricambio degli host. Inoltre, è necessario disabilitare a livello di sistema operativo l'accettazione delle gratuitous Reply, ovvero messaggi ARP Reply non sollecitati da una precedente ARP Request.. 
