...
L'elaborato è composto da un primo capitolo di introduzione all'argomento delle reti di elaboratori, fino al raggiungimento della motivazione per la stesura dello stesso. Il passo successivo è la discussione delle soluzioni già presenti in letteratura  e, successivamente, affrontare i motivi dello sviluppo di una mia reinterpretazione personale di una di esse. In conclusione, vengono presentate le descrizioni e le evidenze dello sviluppo, nonché il futuro che siamo in grado di prevedere per questo progetto.
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{immagini/OSI_Model_Italiano.jpg}
