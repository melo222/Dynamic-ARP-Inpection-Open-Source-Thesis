\chapter{Testing ed Evidenze}
    ...
    Per ottenere le metriche definite nella sezione \ref{sez:criteri_obbiettivi} senza alterare significativamente le prestazioni del sistema è stato necessario "attrezzare" il codice sorgente.
